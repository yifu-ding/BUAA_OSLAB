...
#endif /* _printf_h_ */
17373123_2019_jac@stu-113:~/17373123-lab/include$ cat print.h
/*
 * Copyright (C) 2001 MontaVista Software Inc.
 * Author: Jun Sun, jsun@mvista.com or jsun@junsun.net
 *
...
#endif
17373123_2019_jac@stu-113:~/17373123-lab/include$ cat queue.h
...
#define LIST_INSERT_TAIL(head, elm, field) do {						\
		if(LIST_EMPTY(head)) {									\
			...
			LIST_FOREACH(LIST_NEXT((elm),field),head,field){				\
				(elm)->field.le_prev = LIST_NEXT((elm),field)->field.le_prev;        \
		    }			\
